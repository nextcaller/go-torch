...
// #cgo LDFLAGS: -lstdc++ -L/opt/libtorch/lib  -ltorch -lc10
// #cgo linux,amd64,gpu CXXFLAGS: -I/usr/local/cuda/include
// #cgo linux,amd64,gpu LDFLAGS: -L/usr/local/cuda/lib64 -lcuda -lcudart -lcublas -lcudnn -L/opt/libtorch/lib -lcudart -lnvrtc-builtins -lnvrtc -lnvToolsExt -lcuda
import "C"
